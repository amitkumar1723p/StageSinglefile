...
import {
  getSingleUserResponseAction,
  updateBidStatusAction,
  updateNotifyStatusAction,
  updateRequirementStatusAcion,
...
export default function SingleUserRespponseAction() {
  ...
  const { data: SingleUserResponseAction_Store, loading } = useSelector(
    (state) => {
  ...
  const firstRoom = SingleUserResponseAction_Store?.notifyData?.find(
    (item) => item?.Room?.length > 0
  );
        ...
        <div className="single-user-response-info-container ">
          <div className="single-user-response-info-top">
            ...
            <div className="single-user-response-info-top-button">
              ...
              <a
                href={`tel:${SingleUserResponseAction_Store?.user?.ContactNumber}`}
              >
          ...
          <div className="single-user-response-info-bottom">
            ...
            <a
              className="text-bolder user-select-none"
      ...
      <div className="single-user-response-filter-container">
        <div className=" main-form-data-section d-flex  mt-3  ">
          <div className=" text-center ">
            ...
            >
              Listings{" "}
              <span>{SingleUserResponseAction_Store?.posts?.length}</span>
            </small>
          </div>
          ...
          <div className=" text-center ">
            ...
            >
              Visits{" "}
              <span>{SingleUserResponseAction_Store?.schedules?.length}</span>
            </small>
          </div>
          ...
          <div className="text-center ">
            ...
            >
              Offers
              <span>{SingleUserResponseAction_Store?.offers?.length}</span>
            </small>
          </div>
          ...
          <div className=" text-center ">
            ...
            >
              Requirements{" "}
              <span>{SingleUserResponseAction_Store?.requireData?.length}</span>{" "}
            </small>
          </div>
          ...
          <div className=" text-center">
            ...
            >
              Notification{" "}
              <span>{SingleUserResponseAction_Store?.notifyData?.length}</span>
            </small>
          </div>
        </div>
      </div>
        ...
        <div className="">
          ...
          <table className="table table-striped">
            <thead className="single-user-response-table-head-container">
              <tr>
                <th scope="col">
                  <span className="fw-normal ">PROPERTY TYPE</span>
                </th>
                <th scope="col">
                  {" "}
                ...
                <th scope="col">
                  {" "}
                  <span className="fw-normal "> POST-ID</span>
                </th>
                <th scope="col">
                  <span className="fw-normal">PROPERTY STATUS</span>
                </th>
                <th scope="col">
                  <span className="fw-normal ">VISIT DATE & TIME </span>
                </th>
                <th scope="col">
                  <span className="fw-normal">VISIT STATUS</span>
                </th>
                {/* <th scope="col"><span className="fw-normal">Visit Time</span></th> */}
              </tr>
            </thead>
            <tbody className="single-user-response-table-body-container">
              {SingleUserResponseAction_Store?.schedules
                ?.slice()
                .reverse()
                .map((item) => {
                  return (
                    <tr>
                      ...
                      <td className="" style={{ width: "210px" }}>
                        <small className=" ">
                          {item?.PostData?.PostId?.BasicDetails?.ApartmentType}
                        </small>
                      </td>
                      <td
                        ...
                        onClick={(e) => {
                          window.open(
                            `/post-detail/${item?.PostData?.PostId?._id}`,
                            "SinglePostDetail"
                          );
                        }}
                      >
                        <small className="">
                          {item?.PostData?.PostId?.LocationDetails?.ProjectName}{" "}
                          - {item?.PostData?.PostId?.LocationDetails?.Landmark}{" "}
                          {item?.PostData?.PostId?.LocationDetails?.City}
                        </small>
                      </td>
                      <td>
                        <small className=" ">
                          {item?.PostData?.PostId?._id}
                        </small>
                      </td>
                      ...
                      <td>
                        <small
                          className={`${
                            item?.PostData?.PostId?.PostVerify === true
                              ? "single-user-response-active"
                              : "single-user-response-inactive"
                          }`}
                        >
                          {item?.PostData?.PostId?.PostVerify === true
                            ? "Active"
                      ...
                      <td>
                        <small className=" ">
                          {item?.VisitDate
                            ...
                            : "N/A"}{" "}
                          ({item?.VisitTime?.From} {item?.VisitTime?.To})
                        </small>
                      </td>
                      <td>
  <small className=" ">
<div className="admin-all-response-remaks admin-custom-dropdown">
  <button
    className={`dropdown-btn ${(localStatusMap[item._id] || item?.VisitStatusData?.Status || "Plan").toLowerCase()}`}
    onClick={() =>
      setSelectedRow((prev) => (prev === item._id ? null : item._id))
    }
  >
    {localStatusMap[item._id] || item?.VisitStatusData?.Status || "Plan"}
    <svg
  ...
  {selectedRow === item._id && (
    <div className="dropdown-options">
      {/* <div className="dropdown-title">Change stage</div> */}
      <div
        className="dropdown-item plan"
        onClick={() => {
          setLocalStatusMap((prev) => ({ ...prev, [item._id]: "Plan" }));
          setScheduleStatus({ status: "Plan", id: item._id });
          setSelectedRow(null);
        }}
      >
        Plan
      ...
      <div
        ...
        onClick={() => {
          setLocalStatusMap((prev) => ({ ...prev, [item._id]: "Done" }));
          setScheduleStatus({ status: "Done", id: item._id });
          setSelectedRow(null);
        }}
      >
        Done
      ...
      <div
        className="dropdown-item replan"
        onClick={() => {
          setLocalStatusMap((prev) => ({ ...prev, [item._id]: "Re-Plan" }));
          setScheduleStatus({ status: "Re-Plan", id: item._id });
          setSelectedRow(null);
        }}
      >
        Re-Plan
          ...
          <table className="table table-striped">
            <thead className={`single-user-response-table-head-container `}>
              <tr>
                ...
                <th scope="col">
                  {" "}
                  <span className="fw-normal">PROJECT PRICE</span>
                </th>
                <th scope="col">
                  {" "}
                  <span className="fw-normal">PROPERTY TYPE</span>
                ...
                <th scope="col">
                  <span className="fw-normal">OFFER PRICE</span>
                </th>
                <th scope="col">
                  <span className="fw-normal"> OFFER DATE</span>
                </th>
                <th scope="col">
            ...
            <tbody className="single-user-response-table-body-container">
              {SingleUserResponseAction_Store?.offers
                ?.slice()
                .reverse()
                .map((item) => {
                  return (
                    <tr>
                      ...
                      >
                        <small className="single-user-response-project-name text-truncate text-nowrap overflow-hidden   d-inline-block w-100">
                          {item?.PostData?.PostId?.LocationDetails?.ProjectName}{" "}
                          -{item?.PostData?.PostId?.LocationDetails?.Landmark}{" "}
                          {item?.PostData?.PostId?.LocationDetails?.Locality}
                        </small>
                      </td>
                      <td>
                        <small className="">
                      ...
                      <td>
                        <small className="">
                          {formatPrice(
                            item?.PostData?.PostId?.PricingDetails
                              ?.ExpectedPrice
                          )}
                        </small>
                      </td>
                      ...
                      <td>
                        <small className="">
                          {item?.createAt
                            ? dateTimeFormatter.format(new Date(item?.createAt))
                            : "N/A"}{" "}
                        </small>
                      </td>
                      <td>
                        ...
                        <div className="admin-all-response-remaks admin-custom-dropdown">
  <button
    className={`dropdown-btn ${(localStatusMap[item._id] || item?.bidStatus?.status || "Made").toLowerCase()}`}
    onClick={() =>
      setSelectedRow((prev) => (prev === item._id ? null : item._id))
    }
  >
    {localStatusMap[item._id] || item?.bidStatus?.status || "Made"}
    <svg
      style={{ marginLeft: "8px", verticalAlign: "middle" }}
      xmlns="http://www.w3.org/2000/svg"
      width="14"
  ...
  {selectedRow === item._id && (
    <div className="dropdown-options">
      {["Made", "Accepted", "Rejected"].map((status) => (
        <div
          key={status}
          className={`dropdown-item ${status.toLowerCase()}`}
          onClick={() => {
            setLocalStatusMap((prev) => ({ ...prev, [item._id]: status }));
            setOfferStatus({ status, id: item._id });
            setSelectedRow(null);
          }}
        >
          {status}
          ...
          <table className="table table-striped">
            <thead className="single-user-response-table-head-container">
              <tr>
                <th scope="col">
                  {" "}
                  <span className="single-fresh-property-type fw-normal ps-4">
                    PROPERTY TYPE
                  </span>
                </th>
                <th scope="col">
                ...
                <th scope="col">
                  {" "}
                  <span className="fw-normal">LISTING STATUS</span>
                </th>
                <th scope="col">
                  {" "}
            ...
            <tbody className="single-user-response-table-body-container">
              {SingleUserResponseAction_Store?.posts
                ?.slice()
                .reverse()
                .map((item) => {
                  return (
                    <tr>
                      <td style={{ maxWidth: "160px" }}>
                        <small className=" ps-4">
                          {item?.BasicDetails?.ApartmentType}
                        </small>
                      </td>
                      <td style={{ maxWidth: "260px" }} className="pe-5">
                        <small
                          ...
                          onClick={() =>
                            window.open(
                              `/post-detail/${item?._id}`,
                              "SinglePostDetail"
                            )
                          }
                        >
                          {item?.LocationDetails?.ProjectName} -
                          {item?.LocationDetails?.Landmark},{" "}
                          {item?.LocationDetails?.City}
                        </small>
                      </td>

                      <td>
                        <small className="">{item?._id}</small>
                      </td>
                      <td>
                        <small
                          className={`ps-3 ${
                            item.PostVerify === true
                              ? "single-user-response-active"
                              : "single-user-response-inactive"
                          }`}
                        >
          ...
          <table className="table table-striped">
            <thead className="single-user-response-table-head-container">
              <tr>
                ...
                <th scope="col">
                  <span className="fw-normal">Required Bhk</span>
                </th>
                <th scope="col">
                  <span className="fw-normal">Floor Prefrence</span>
                </th>
            ...
            <tbody className="single-user-response-table-body-container">
              {SingleUserResponseAction_Store?.notifyData
                ?.slice()
                .reverse()
                .map((item) => {
                  return (
                    <tr>
                      ...
                      <td>
                        <small className="">{item?.BHKType}</small>
                      </td>
                      <td>
                        <small className="">{item?.FloorPreference}</small>
                      </td>
                      {item?.Room.length > 0 ? (
                        <td>
                      ...
                      <td>
                        ...
                        <div className="admin-all-response-remaks admin-custom-dropdown">
  <button
    className={`notify-dropdown-btn ${(localStatusMap[item._id] || item?.notifyStatus?.status || "Pending").toLowerCase()}`}

    onClick={() =>
      setSelectedRow((prev) => (prev === item._id ? null : item._id))
    }
  >
    {localStatusMap[item._id] || item?.notifyStatus?.status || "Pending"}
    <svg
      style={{ marginLeft: "8px", verticalAlign: "middle" }}
      xmlns="http://www.w3.org/2000/svg"
      width="14"
    ...
    <div className="dropdown-options">
      {["Pending", "Completed"].map((status) => (
        <div
          ...
          onClick={() => {
            setLocalStatusMap((prev) => ({ ...prev, [item._id]: status }));
            setNotifyStatus({ status, id: item._id });
            setSelectedRow(null);
          }}
        >
          {status}
          ...
          <table className="table table-striped">
            <thead className="single-user-response-table-head-container">
              <tr>
                ...
                <th scope="col">
                  <span className="fw-normal">BHK Type</span>
                </th>
                <th scope="col">
                  <span className="fw-normal">Budget</span>
                </th>
                <th scope="col">
                  <span className="fw-normal">Date</span>
                </th>
            ...
            <tbody className="single-user-response-table-body-container">
              {SingleUserResponseAction_Store?.requireData?.map((item) => {
                return (
                  <tr>
                    <td>
                      <small className="">{item?.PropertyType}</small>
                    </td>
                    <td>
                      <small className=" text-truncate text-nowrap overflow-hidden  d-inline-block w-100 ">
                        {item?.ProjectName}
                      </small>
                    </td>
                    ...
                    <td>
                      <small>
                        {item?.FloorPreference ? item.FloorPreference : "----"}
                      </small>
                    </td>

                    <td>
                      <small className="">
                        {item?.BHKType ? item?.BHKType : "----"}
                      </small>
                    </td>
                    <td>
                      <small className="">
                    ...
                    <td>
                      ...
                      <div className="admin-all-response-remaks admin-custom-dropdown">
  <button
    className={`notify-dropdown-btn ${(localStatusMap[item._id] || item?.requirementStatus?.status || "Pending").toLowerCase()}`}
    onClick={() =>
      setSelectedRow((prev) => (prev === item._id ? null : item._id))
    }
  >
    {localStatusMap[item._id] || item?.requirementStatus?.status || "Pending"}
    <svg
      style={{ marginLeft: "8px", verticalAlign: "middle", fill: "#ffffff" }}
      xmlns="http://www.w3.org/2000/svg"
      width="14"
      height="14"
      viewBox="0 0 16 16"
    ...
    <div className="dropdown-options">
      {["Pending", "Completed"].map((status) => (
        <div
          ...
          onClick={() => {
            setLocalStatusMap((prev) => ({ ...prev, [item._id]: status }));
            setRequirementStatus({ status, id: item._id });
            setSelectedRow(null);
          }}
        >
          {status}

  ...
  return (
    <>
      <div className="conatiner">
        <div
          className=" mb-3  d-flex shadow-sm"
        ...
        >
          <div className="col-2 ">
            ...
            >
              ...
              {allFreshBooking?.map((item, index) => (
                <option value={item?.projectBasicDetail?.projectName}>
            ...
            {projectName ? (
              <div className="">
                <small className="fw-light " onClick={() => setProjectName()}>
                  {projectName}
          ...
          <div className="col-1">
            ...
            {type ? (
              <div className="">
                <small className="fw-light " onClick={() => setType()}>
                  {type}
          ...
          <div className="col-2">
            ...
            >
              ...
              {allFreshBooking?.map((item, index) => (
                <option
                  key={index}
                  value={`${item?.projectBasicDetail?.locality || "N/A"},${
                    item?.projectBasicDetail?.projectCity || "N/A"
                  }`}
                >
                  {item?.projectBasicDetail?.locality || "N/A"},{" "}
                  {item?.projectBasicDetail?.projectCity || "N/A"}
                </option>
              ))}
            </select>
          ...
          <div className="d-flex h-50">
            <input
              type="text"
              placeholder="e.g:Dlf The Primus"
              className="my-2 form-select-viewAll "
              onChange={(e) => setSearchText(e.target.value)}
              value={searchText}
            />
            <button className="my-2 border-0 bg-body">

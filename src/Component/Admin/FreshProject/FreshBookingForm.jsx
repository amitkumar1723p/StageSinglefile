...
//    ----------------
        ...
        if (inputValue.trim() !== "") {
            ...
            setFromData({
                ...formData, projectHightlight: {
                    ...(formData.projectHightlight || []),
                    [key]: [...(formData.projectHightlight?.[key] || []), [key] = inputValue]
                }
            })
    ...
    const handleDeleteProjectHighlight = (index) => {
        ...
        setFromData({ ...formData, projectHightlight: { ...formData.projectHightlight, [key]: updatedLocation } })
    ...
    const handleSubmit = (e) => {
        ...
        if (id) {
            ...
            if (formData.aboutProject) {
                formDataNew.append('aboutProject', JSON.stringify(formData.aboutProject));
            }
            ...
            if (formData?.projectLocation) {
                // Define the allowed keys, excluding locationImage for now
                 ...
                 formDataNew.append("projectLocation" ,JSON.stringify(formData?.projectLocation))
                ...
                <form onSubmit={handleSubmit} encType='multipart/form-data'>
                        ...
                        <div className='d-flex flex-column gap-2'>
                            ...
                            <div className='d-flex flex-wrap gap-4 p-2 ' >
                                <div className='freshbooking-ProjectName '>
                                    ...
                                    <input type="text" value={formData?.projectBasicDetail?.projectName}
                                ...
                                <div>
                                    ...
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type="text" placeholder='e.g Sector 74A'
                                        onChange={(e) => setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, locality: e.target.value } })} value={formData?.projectBasicDetail?.locality} />
                                </div>
                                <div>
                                    <p style={{ color: "#16315F", fontSize: '14px' }}>City/State*</p>
                            ...
                            <div className='d-flex flex-wrap gap-4  p-2'>
                                <div>
                                    ...
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='phone' placeholder='e.g 2.6' required
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, minPrice: e.target.value } }) }} value={formData?.projectBasicDetail?.minPrice} />
                                </div>
                                <div>
                                    <p style={{ color: "#16315F", fontSize: '14px' }}>Maximum Price (In CR)*</p>
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='phone' placeholder='e.g 5.7'
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, maxPrice: e.target.value } }) }} value={formData?.projectBasicDetail?.maxPrice} />
                                </div>
                                <div>
                                    <p style={{ color: "#16315F", fontSize: '14px' }}>Possession Year</p>
                                    <input className='  rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='phone' placeholder='e.g 2077'
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, possessionStatus: e.target.value } }) }} value={formData?.projectBasicDetail?.possessionStatus} />
                                </div>
                                <div>
                                    <p style={{ color: "#16315F", fontSize: '14px' }}>Payment Plan</p>
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='phone' placeholder='e.g  50|50  30|70'
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, projectPaymentPlan: e.target.value } }) }} value={formData?.projectBasicDetail?.projectPaymentPlan} />
                                </div>
                                <div>
                                    ...
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='phone' placeholder='e.g abcd123'
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, projectReraId: e.target.value } }) }} value={formData?.projectBasicDetail?.projectReraId} />
                                </div>
                            </div>
                            ...
                            <div className='d-flex flex-wrap gap-4  p-2'>
                                <div>
                                    ...
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='text' placeholder='e.g 8'
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, totalLandArea: e.target.value } }) }} value={formData?.projectBasicDetail?.totalLandArea} />
                                </div>
                                <div>
                                    <p style={{ color: "#16315F", fontSize: '14px' }}>Total Tower*</p>
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='text' placeholder='e.g 4'
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, towerNumber: e.target.value } }) }} value={formData?.projectBasicDetail?.towerNumber} />
                                </div>
                                <div>
                                    <p style={{ color: "#16315F", fontSize: '14px' }}>Total Units*</p>
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='text' placeholder='e.g 340'
                                        onChange={(e) => { setFromData({ ...formData, projectBasicDetail: { ...formData.projectBasicDetail, totalUnit: e.target.value } }) }} value={formData?.projectBasicDetail?.totalUnit} />
                                </div>
                        ...
                        <div className='freshbooking-project-highlight-main-coctainer d-flex gap-2 justify-content-between'>
                            ...
                            <div className='freshbooking-projekt-highlight-container'>
                                ...
                                <div className='freshbooking-highlights-description'>
                                    ...
                                    <textarea placeholder="Enter your message here..." className=' rounded-1 w-100 p-2'
                                        style={{ border: "1px solid rgba(198, 230, 255, 1)", minHeight: '155px', resize: "none" }} type='text'
                                        onChange={(e) => { setFromData({ ...formData, aboutProject: { ...formData.aboutProject, aboutProjectContent: e.target.value } }) }} value={formData?.aboutProject?.aboutProjectContent} />
                                </div>
                                ...
                                <div className='freshbooking-highlights-description'>
                                    ...
                                    <div className='d-flex gap-2'>
                                        <input type="text" className=' rounded-1 p-2'
                                            style={{ border: "1px solid rgba(198, 230, 255, 1)", width: '220px' }} placeholder="Enter item..."
                                            value={inputValue} onChange={(e) => setInputValue(e.target.value)} />
                                        <div className=" " onClick={handleAddProjectHighlights}>Add</div>
                                    </div>
                                </div>
                                <div>
                                    <ul className="mt-3 list-group">hightlightContent
                                        {formData?.projectHightlight?.hightlightContent?.map((item, index) => (
                                            <li key={index} className="list-group-item py-2 fw-light">
                                                <small className='pe-3'>{item}</small>
                                                <span type="button" className="text-white fw-bolder px-2 bg-danger rounded-5" onClick={() => handleDeleteProjectHighlight(index)}>
                                                    X
                                                </span>
                                            </li>
                                        ))}
                    ...
                    <div className="rounded-3 d-flex flex-column gap-3 p-3 " style={{ boxShadow: "0px 0px 10px rgba(198, 221, 238, 1)" }}>
                        ...
                        <div className=" freshbooking-gallery-image-section position-relative m-auto p-4 text-center rounded d-flex flex-column align-items-center justify-content-center" style={{
                            ...
                            <input className='position-absolute border top-0 start-0 w-100 h-100 opacity-0' type="file" multiple accept="image/jpeg, image/png, image/svg+xml"
                                onChange={handleGalleryImages} id="imageUploadProjectGallery"/>
                        ...
                        <div className='freshbooking-gallery-image-viewer w-100 d-flex' >
                            {galleryImages.length > 0 ? (
                                ...
                                {formData?.projectGallery?.map((item, index) => (
                                    <div key={index} className="position-relative" style={{ width: "150px" }}>
                                        <div className="border rounded p-2 bg-light position-relative">
                                            <img src={item?.url} alt="Preview" className="img-fluid rounded" style={{ width: "100%", height: "150px", objectFit: "cover" }} />
                                            <div
                                                type="div"
                                                className="btn-close position-absolute top-0 end-0 m-2"
                                                style={{ backgroundColor: '#6c757d' }}
                    ...
                    <div className="rounded-3 d-flex flex-column gap-3 p-3 " style={{ boxShadow: "0px 0px 10px rgba(198, 221, 238, 1)" }}>
                        ...
                        <div className='d-flex justify-content-between w-100'>
                            ...
                            <div className=" freshbooking-floor-plan-image-upload position-relative p-4 text-center rounded m-auto" style={{
                                ...
                                <input className='position-absolute border top-0 start-0 w-100 h-100 opacity-0' type="file" multiple accept="image/jpeg, image/png, image/svg+xml" onChange={handleFloorPlan} id="imageUploadProjectFloorPlan" />
                                <label htmlFor="file-upload" className="d-block">
                                    <div className="text-center">
                                        <i className="bi bi-upload" style={{ fontSize: "2rem" }}></i>
                                        <p className="text-primary" style={{ cursor: "pointer" }}>Drag and drop or click to choose file</p>
                        ...
                        <div className='freshbooking-about-project-data-container d-flex  gap-5'>
                            ...
                            <div className='w-100 d-flex flex-column gap-3'>
                                <div className=' d-flex flex-column gap-1'>
                                    ...
                                    <input className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='text' placeholder=' Project Builder Name*'
                                        onChange={(e) => { setFromData({ ...formData, projectAboutBuilder: { ...formData.projectAboutBuilder, projectAboutBuilderName: e.target.value } }) }} value={formData?.projectAboutBuilder?.projectAboutBuilderName} />
                                </div>
                                <div className='d-flex flex-column gap-1'>
                                    <p style={{ color: "#16315F", fontSize: '14px' }}>Project Builder Description*</p>
                                    <textarea className=' rounded-1 p-2 w-100' style={{ border: "1px solid rgba(198, 230, 255, 1)", minHeight: '120px', resize: "none" }} type='text' placeholder='Project Builder Description*'
                                        onChange={(e) => { setFromData({ ...formData, projectAboutBuilder: { ...formData.projectAboutBuilder, projectAboutBuilderContent: e.target.value } }) }} value={formData?.projectAboutBuilder?.projectAboutBuilderContent} />
                                </div>
                        ...
                        <div className=' d-flex flex-column gap-3 '>
                            ...
                            <div className='freshbooking-about-seo-container d-flex gap-3 flex-wrap'>
                                <div className='freshbooking-project-meta-title-container d-flex flex-column gap-2 '>
                                    ...
                                    <input className=' rounded-1 p-3' style={{ border: "1px solid rgba(198, 230, 255, 1)" }} type='text' placeholder=' Project Builder Name'
                                        onChange={(e) => { setFromData({ ...formData, projectMeta: { ...formData.projectMeta, projectTitle: e.target.value } }) }} value={formData?.projectMeta?.projectTitle} />
                                </div>
                                <div className='freshbooking-project-manager-contact-container d-flex flex-column gap-2 '>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => { setFromData({ ...formData, projectManagerContact: e.target.value.trim() }) }} value={formData?.projectManagerContact} />
                                </div>
                            ...
                            <div className='freshbooking-project-meta-description-container  d-flex flex-column gap-2 '>
                                ...
                                <textarea className=' rounded-1 p-2' style={{ border: "1px solid rgba(198, 230, 255, 1)", minHeight: '120px', width: '100%', maxWidth: '500px', resize: "none" }} type='text' placeholder='Project Meta Description'
                                    onChange={(e) => { setFromData({ ...formData, projectMeta: { ...formData.projectMeta, projectDescripation: e.target.value } }) }} value={formData?.projectMeta?.projectDescripation} />
                            </div>
                    ...
                    <button className=' my-4 mx-auto py-2 px-5 border fs-5 rounded-3 text-white' style={{ backgroundColor: '#1877f2' }} type='submit'>{id ? <>update</> : <>submit</>}</button>
                </form>
            </div>
        </div>
    )

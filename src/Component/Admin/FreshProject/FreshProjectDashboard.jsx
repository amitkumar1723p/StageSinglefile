    ...
    return (
         ...
         <div className='container-fluid'>
            <div className="container d-flex">
                ...
                <div className="card border-primary mb-3 m-4 text-center border-opacity-25" style={{ maxWidth: "25%" }}>
                <Link to="/admin/fresh-property/create">
                    <div className="card-body  p-5 shadow-sm ">
                        ...
                        <small className='fw-light text-primary border-bottom border-primary border-3 pb-1'>View All</small>
                    </div>
                    </Link>
                </div>

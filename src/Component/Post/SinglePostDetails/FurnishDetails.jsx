...
const furnishingData = [
  ...
  { name: "Water Purifier", icon: "/img/water-purifier.svg" },
  { name: "Chimney", icon: "/img/chimney.svg" },
  { name: "Sofa", icon: "/img/sofa.svg" },
  { name: "Exhaust Fan", icon: "/img/exhaust-fan.svg" },
  { name: "Dining Table", icon: "/img/dining.svg" },
  { name: "Curtains", icon: "/img/curtains.svg" },
  { name: "Micro Wave", icon: "/img/microwave.svg" },
  { name: "Fridge", icon: "/img/fridge.svg" },
  { name: "Washing Machine", icon: "/img/washing-machine.svg" },
];

          ...
          {/* <p className="sold-out-lable">This property is sold out</p> */}
                    ...
                    {PostData.PostVerifyShow ? (
                        PostData.PostVerify ? (
                            <div className="single-card-verified-badge">
                                <img src="/img/verified-tag.svg" className='single-card-verified-icon' alt="verified-tag" />
                ...
                <div className="single-card-title-section">
                    <div className="single-card-title-actions-container">
                        <h2 className={`single-card-property-title  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>{PostData.LocationDetails.ProjectName}</h2>
                        ...
                        <div className="share-fav-main-box">
                            <div className="postcard-share-parent">
                                <button className='single-page-share-button' disabled={PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? false: true} onClick={() => setIsModalOpen(true)}>
                                    <img
                    ...
                    <p className={`single-card-property-location truncate-text  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`} >
                        {PropertyAddress}
                    </p>
                </div>
                ...
                <div className={ `single-card-details-container  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>
                    {/* Left Button */}
                    <button className={`slider-btn slider-btn-left ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}  disabled={PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? false: true} onClick={scrollLeft}>
                        <FaChevronLeft size={17} />
                    </button>

                    {/* Scrollable Container */}
                    <div ref={sliderRef} className={`single-card-details-slide ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"} `}>
                        <div className="single-card-detail-item">
                            <div className="single-card-detail-icon-container">
                            ...
                            <div className="single-card-detail-text ">
                                <p className={`single-card-detail-title  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>
                                    {PostData.AmenitiesDetails.Furnishing}
                                </p>
                                <p className={`single-card-detail-subtitle  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>Furnishing Details</p>
                            </div>
                        </div>
                        ...
                        <div className="single-card-detail-item">
                            ...
                            <div className="single-card-detail-text">
                                <p className={`single-card-detail-title  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>{floorDetails}</p>
                                <p className={`single-card-detail-subtitle  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>Floor</p>
                            </div>
                        </div>
                        ...
                        <div className="single-card-detail-item">
                            ...
                            <div className="single-card-detail-text">
                                ...
                                <p className={`single-card-detail-subtitle  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>{areaDetails?.label}</p>
                            </div>
                        </div>
                        ...
                        <div className="single-card-detail-item">
                            ...
                            <div className="single-card-detail-text">
                                ...
                                <p className={`single-card-detail-subtitle  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>Type</p>
                            </div>
                        </div>
                    </div>

                    {/* Right Button */}
                    <button  className={`slider-btn slider-btn-right ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}  disabled={PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? false: true} onClick={scrollRight}>
                  ...
                  <>
                    <>
                      <div className="single-card-rent-price-section">
                        <div>
                          <p className={`rent-price-ans  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>
                            {formatReservePrice(
                        ...
                        <div>
                          <div className="Reserveprice-sec">
                            <div className="Reserveprice-sec-grid">
                              ...
                              <p  className={`single-card-rent-price-value  ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out"}`}>Deposit Amount </p>
                            </div>
                          </div>
                        </div>
                      </div>
...
{PostData.BasicDetails.PropertyAdType == "Sale" && (
                      <>
                        <div className='single-card-price-section-sale'>
                          ...
                          <p className={`single-post-card-persqft ${false ? "" : "sold-out"} `}>
                    ...
                    <p className="single-card-publish-date">
                        ...
                        <span className="single-card-date-value"> {formatDate(PostData.PostVerifyData?.Time)}</span>
                    </p>
                </div>
                ...
                <div className="single-card-action-buttons-container">
                      ...
                      <Link className=''
                                  ...
                                  >
                                    <button className={`single-card-action-button ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out-button"}`} disabled={PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? false: true}>View More</button>
                                  </Link>
                    <button className={`single-card-action-button ${PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? "" : "sold-out-button"}`} disabled={PostData?.propertyStatus?.currentPropertyStatus!=="sold out" ? false: true}>GET BROCHURE</button>
                </div>
            </div>
            {/* share card begin  */}

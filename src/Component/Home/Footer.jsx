...
const Footer = () => {
  ...
  `)}`}
        ...
        <div className="footer-column">
          <h3>Contact</h3>
          <p>Contact No : <br /> +91 783-784-0785</p>
          <p className="email-section-footer"  >Support: <br />  support@propertydekho247.com</p>
          <p className="email-section-footer"  >Sales : <br /> sales@propertydekho247.com</p>
        </div>
        <div>
          <p className="last-p">

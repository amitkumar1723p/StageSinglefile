...
export default function BlogArticles() {
    ...
    const Blogs=[
        ...
        },
        {
            ...
            imgUrl:"/img/blogImg/luxuary-homes.png",
        },
        {
            id:8,
            date:"14 Aug 2024",
            ...
            {Blogs.map(blog =>(
                <div className={`blog-card blog-card-${blog.id}`}>
                    ...
                    <div className='blog-card-data'>
                        ...
                        <div className='blog-card-button'><Link to={`/blog-page/${formatTitleForURL(blog.title)}`}><button>Read More <img src="/img/blogImg/blog-readmore-logo.svg" ></img> </button></Link> </div>
                    </div>

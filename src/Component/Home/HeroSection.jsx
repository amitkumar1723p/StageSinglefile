...
const HeroSection = () => {
 ...
 <div className="d-flex flex-column align-items-center">
   <button className="hero-contact-btn mb-3">
     <div className="hero-icon-container">
     <Link to="tel:+917837840785" className="call-button"> 
       <Headphones className="hero-float-icon text-primary" /></Link>
     </div>
     <div className="hero-icon-floating-label-container">
       <span className="hero-icon-floating-label">Contact Us    
       </span>
     </div>
   </button>
   ...
   <button className="hero-contact-btn mb-3">
     <div className="hero-icon-container">
       ...
       <Phone className="hero-float-icon text-danger" />
       </div>
     </div>
     <div className="hero-icon-floating-label-container">
   ...
   <button className="hero-contact-btn mb-3">
     <div className="hero-icon-container">
       <div className="hero-floating-icons">
       <Hand className="hero-float-icon text-primary" />
       </div>
     </div>
     <div className="hero-icon-floating-label-container">
       <span className="hero-icon-floating-label">Click Here</span>
     </div>
   </button>

   {/* <button className="hero-contact-btn apply-btn">
     <div className="hero-icon-container">
       <div className="apply-text">Apply Online</div>
     </div>
     <div className="hero-icon-floating-label-container">
       <span className="hero-icon-floating-label">Apply Now</span>
     </div>
   </button> */}
 </div>
 </div>

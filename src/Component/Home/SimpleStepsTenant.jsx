      ...
      <div className="simple-steps-container">
        <div className="simple-step-card" id="step1">
          <div className="howwework-data">
            <img
                      loading="lazy" src="/img/StartExploring.png" alt="Start Exploring" />
        ...
        <div className="simple-step-card" id="step2">
          <div className="howwework-data">
          <img
                      loading="lazy" src="/img/ConnectwithUs.png" alt="Start Exploring" />
            <h3>Lets Connect</h3>
        ...
        <div className="simple-step-card" id="step3">
          <div className="howwework-data">
          <img
                      loading="lazy" src="/img/ScheduleyourVisit.png" alt="Start Exploring" />
        ...
        <div className="simple-step-card" id="step4">
          <div className="howwework-data">
          <img
                      loading="lazy" src="/img/SubmityourOffer.png" alt="Start Exploring" />
